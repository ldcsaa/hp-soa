 ...
 * limitations under the License.
 */
package io.github.hpsocket.soa.starter.data.redis.redisson;
...
public class PropertiesRedisConnectionDetails implements RedisConnectionDetails {
    ...
    public Cluster getCluster() {
        ...
        List<Node> nodes = (cluster != null) ? cluster.getNodes().stream().map(this::asNode).collect(Collectors.toList()) : null;
